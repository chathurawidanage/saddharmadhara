...
I also acknowledge that this meditation program is not intended as a recommendation, remedy, or approved treatment for any physical or mental illness, complication, pain, or problem that I may currently have.`,
        [SINHALA_LOCALE]: `මා විසින් ඉහත සපයා ඇති තොරතුරු සියල්ල සත්‍ය හා නිවැරදි බව මින් තහවුරු කරමි. අසත්‍ය තොරතුරු ඉදිරිපත් කිරීම මෙම භාවනා වැඩසටහනට නුසුදුස්සකු වන බවත් නැවත භාවනා වැඩසටහනකට අයදුම් කිරීමේ ඇති අවස්ථාව ද ඉන් මගහැරී යන බව ත් දනිමි.

...
const preperationsPage = {
  ...
  elements: [
    agreeDisagreeQuestion("NoPhones", {
      [ENGLISH_LOCALE]:
    ...
    agreeDisagreeQuestion("NoBadHabbits", {
      [ENGLISH_LOCALE]:
    ...
    agreeDisagreeQuestion("DoAshubaBhavana", {
      [ENGLISH_LOCALE]:
    ...
    agreeDisagreeQuestion("DoMaithreeBhavana", {
      [ENGLISH_LOCALE]:
    ...
    agreeDisagreeQuestion("UnderstandTrividaRathna", {
      [ENGLISH_LOCALE]:
    ...
    agreeDisagreeQuestion("ReadFourNobleTruths", {
      [ENGLISH_LOCALE]:

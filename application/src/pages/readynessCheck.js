...
const readynessCheckPage = (isRequired) => {
  return {
    name: "ReadynessCheck",
    title: {
      [ENGLISH_LOCALE]: "❤️‍🩹 Physical and psychological attachments and health conditions",
      [SINHALA_LOCALE]: "❤️‍🩹 කායික/මානසික බැදියාවන් සහ සෞඛ්‍ය තත්වයන්",
    },
    description: {
      [ENGLISH_LOCALE]:
    ...
    elements: [
      ...yesNoQuestionWithComment(
        "HasPermission",
        {
          ...
          [SINHALA_LOCALE]:
            "ඔබට මෙම නේවාසික භාවනා වැඩසටහන හා සම්බන්ධ වීමට දෙමව්පියන්ගෙන්/භාරකරුගෙන්/රැකියා කරන ස්ථානයෙන් සහ වෙනත් එවැනි විශේෂ වගකිවයුතු සම්බන්ධතාවලින්(පූජ්‍ය පපක්ෂය  සඳහා - වැඩසටහනට සහභාගී වීමට විහාරාධිපති ස්වාමින්වහන්සේ ගේ හෝ ආචාර්‍යන්වහන්සේගේ අවසරය) සම්පූර්ණ අවසරය ලැබී තිබේ ද?",
        },
        isRequired,
        false
      ),

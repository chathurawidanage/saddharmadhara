...
export const DHIS2_DASHBOARD_PARTICIPATION_SUMMARY_SQL_VIEW = "R8FwZk7IIZv";
export const DHIS2_DASHBOARD_EOI_SUMMARY_SQL_VIEW = "TfXwtFygp3K";
...
export const DHIS2_SEASON_OPTION_SET_ID = "MTGvmXoSPeo";
export const DHIS2_RETREAT_SEASON_ATTRIBUTE = "Et5VfQ38DAu";
...
export const DHIS2_RETREAT_FEMALE_YOGIS_ATTRIBUTE = "rVHAuTlxAT9";
export const DHIS2_RETREAT_MALE_YOGIS_ATTRIBUTE = "Ch7NB6Q6sCO";
...
export const DHIS2_RETREAT_ATTENDANCE_CONFIRMATION_DATE_ATTRIBUTE =
  "kFY4NT5LxnJ";
...
export const DHIS2_RETREAT_SELECTION_STATE_PENDING_CONFIRMATION_CODE =
  "pending";
...
export const DHIS2_TEI_ATTRIBUTE_WHATSAPP = "CpF36JSasMJ";
...
export const DHIS2_TEI_ATTRIBUTE_ORDINATION_INTENDED = "kT2ExGjYbPS";

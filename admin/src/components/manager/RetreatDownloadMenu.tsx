...
interface RetreatDownloadMenuProps {
  onDownload: (gender: string, selectionState: string, format: string) => void;
}

const RetreatDownloadMenu = ({ onDownload }: RetreatDownloadMenuProps) => {
  return (
    <DropdownButton
      component={
        <FlyoutMenu>
